...
const STRICT_FACADES = {
  ...
  './production': {
    ...
    runtime: [
      ...
      { name: 'createStrictTestDimensionAgentCellAnalysisEvidenceV1', kind: 'function' },
      { name: 'createStrictTestDimensionAgentCellStageEvidenceV1', kind: 'function' },
      { name: 'createStrictTestDimensionAgentExecutionReceiptV1', kind: 'function' },
      { name: 'createStrictTestDimensionAgentPipelineExecutionV1', kind: 'function' },
      { name: 'hashStrictTestDimensionAgentStageResultV1', kind: 'function' },
